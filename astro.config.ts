...
export default defineConfig({
  ...
  // Native Fonts API with local variable fonts from @fontsource-variable/*:
  // self-hosted, preloaded, and no third-party font API needed at build time.
  // Injected via <Font /> in Layout.astro and consumed through the CSS
  // variables in CustomStyles.astro.
  fonts: [
    {
